# ============================================================
#  MONSTER WRANGLER — Build Day 2
#  Principles of Computing | Unit 3 — OOP + Game Projects
#  March 9, 2025
# ============================================================
#
#  TODAY'S GOAL: Complete the Monster class and wire up
#  collision detection so the game is actually playable.
#
#  Day 1 gave you: Game class + Player class (all done ✅)
#  Day 2 (Today):
#    TODO 1 → Game.choose_new_target()
#    TODO 2 → Game.start_new_round()   (add the spawn loop)
#    TODO 3 → Game.check_collisions()
#    TODO 4 → Uncomment check_collisions() in Game.update()
#
#  HOW TO TEST: Run after each TODO. Monsters should appear and
#  bounce around the play area. Catching the right type scores
#  points; catching the wrong type costs a life.
#
...
class Game():
    ...
    #                  set running = False  (hint: global running)
    #            • else:
